...
elaborate()
{
  ...
  xelab --relax --debug typical --mt auto --include "../../../../zcu104_custom_platform.gen/sources_1/bd/system/ip/system_zynq_ultra_ps_e_0_0/sim_tlm" --include "../../../bd/system/ip/system_zynq_ultra_ps_e_0_0/sim" --include "$xv_boost_lib_path" -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_15 -L generic_baseblocks_v2_1_0 -L fifo_generator_v13_2_5 -L axi_data_fifo_v2_1_21 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_22 -L axi_protocol_converter_v2_1_22 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm -sv_root "." -sc_lib libdpi --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xv_lib_path="/media/avt/UbuntuExt/tools/tools/Xilinx/Vivado/2020.2/lib/lnx64.o/Ubuntu:/media/avt/UbuntuExt/tools/tools/Xilinx/Vivado/2020.2/lib/lnx64.o"
